...
public interface StudentDao {
	...
	// 删除学生的选课
	public int deleteStuCur(@Param("stuId") Integer stuId, @Param("curTeaId") Integer curTeaId);

	// 增加学生的选课
	public int addStuCur(@Param("stuId") Integer stuId, @Param("curTeaId") Integer curTeaId);
