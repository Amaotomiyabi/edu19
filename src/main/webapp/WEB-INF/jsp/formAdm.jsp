...
<body>
				...
				<div class="row-fluid">
					<div class="box span12">
						...
						<div class="box-content">
							<form class="form-horizontal" id="update_adm_form1">
								<input type="hidden" name="_method" value="put" /> <input
									type="hidden" name="admin_id" value="${admInfo.admin_id }" />
								<fieldset>
									<div class="control-group success">
										<label class="control-label" for="admin_name">姓名</label>
										<div class="controls">
											<h5 id="admin_name">${admInfo.admin_name }</h5>
										</div>
									</div>
									<div class="control-group success" style="margin-top: 20px;">
										...
										<div class="controls">
											<input type="text" id="teacher_password"
												...
												value="${admInfo.admin_account }" />
										</div>
									</div>
									<div class="control-group success">
										<label class="control-label" for="admin_password">密码</label>
										<div class="controls">
											<input type="text" id="admin_password" required="required"
												name="admin_password" value="${admInfo.admin_password }" />
										</div>
									</div>
									<div class="control-group success">
										<label class="control-label" for="admin_phone">电话</label>
										<div class="controls">
											<input type="text" id="admin_phone" required="required"
												name="admin_phone" value="${admInfo.admin_phone }" />
										</div>
									</div>
									<div class="form-actions">
										<button type="button" class="btn btn-primary" id="update_adm_but1"
											onclick="update_adm()">Save changes</button>
	...
	<script>
		function update_adm() {
			$.ajax({
				type : "post",
				url : "${pageContext.request.contextPath}/admin/info",
				data : $("#update_adm_form1").serialize(),
