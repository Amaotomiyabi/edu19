...
<body>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form class="form-horizontal" id="mt_form_add1"
												action="${pageContext.request.contextPath }/markTable"
												method="post">
												<fieldset>
													<div class="control-group">
														<label class="control-label" for="student.stu_id">学生ID</label>
														<div class="controls">
															<input type="text" id="student.stu_id"
																name="student.stu_id" required="required" />
														</div>
													</div>
													<div class="control-group" style="margin-top: 20px;">
														<label class="control-label" for="course.cur_teacher_id">课程识别号</label>
														<div class="controls">
															<input type="text" id="course.cur_teacher_id"
																name="course.cur_teacher_id" />
														</div>
													</div>
													<div class="control-group">
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" id="m_exam_mark" name="m_exam_mark"
																required="required" />
														</div>
													</div>
												</fieldset>
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-primary"
												id="add_mt_but1" onclick="add_mt()">确认</button>
										</div>
									</div>
								</div>
							</div>
								...
								<tbody>
									<c:forEach items="${mtList }" var="mt">
										<tr>
											...
											<td class="center">${mt.course.teacher.teacher_name }</td>
											...
											<td class="center"><a class="btn btn-info" href="#"
												...
												data-target="#deleteOne${mt.mark_id }"> <i
													class="icon-trash "></i>
											</a>
												...
												<div class="modal fade" tabindex="-1" role="dialog"
													id="deleteOne${mt.mark_id }" style="display: none">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<button class="close" type="button" data-dismiss="modal"
															...
															<div class="modal-footer">
																<button type="button" class="btn btn-default"
																	data-dismiss="modal">取消</button>
																<button type="button" class="btn btn-primary"
																	id="delete_mt_but1" onclick="delete_mt(${mt.mark_id})">确认</button>
															</div>
														</div>
													</div>
												</div></td>
	...
	<!-- end: JavaScript-->
	<script>
	 function delete_mt(mtId)
	 {
		 $.ajax({
			data:{_method:"DELETE",mtId:mtId},
			type:"post",
