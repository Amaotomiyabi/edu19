				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header" data-original-title="">
							<h2>
								<i class="icon-user-md"></i><span class="break"></span>课表
							</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							<table
								...
								<tbody>
									<c:forEach items="${stuCurList }" var="stuCurOne">
										<tr>
											<td>${stuCurOne.cur_teacher_id }</td>
											<td class="center">${stuCurOne.cur_name }</td>
											<td class="center">${stuCurOne.teacher.teacher_name }</td>
											<td class="center">${stuCurOne.teacher.teacher_phone }</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
