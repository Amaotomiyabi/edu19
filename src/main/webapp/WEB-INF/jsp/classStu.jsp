...
<body>
				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header" data-original-title="">
							<h2>
								<i class="icon-user-md"></i><span class="break"></span>课程学生表
							</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							<table
								...
								<tbody>
									<c:forEach items="${claStuList }" var="claStuOne">
										<tr>
											<td>${claStuOne.stu_num }</td>
											<td class="center">${claStuOne.stu_name }</td>
											<td class="center"><a class="btn btn-danger" href="#"
												data-toggle="modal"
												data-target="#deleteClaStuOne${claStuOne.stu_id}" title="删除">
													<i class="icon-trash "></i>
											</a>
												<div class="modal fade" tabindex="-1" role="dialog"
													id="deleteClaStuOne${claStuOne.stu_id}"
													style="display: none">
													>
														...
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<button type="button" class="btn btn-primary"
																	id="delete_claStu_but1"
																	onClick="delete_claStu(${claStuOne.stu_id},${claId })">确认</button>
															</div>
														</div>
													</div>
												</div></td>
									...
									<c:forEach items="${stuList }" var="stuOne">
										<tr>
											...
											<td class="center"><a class="btn btn-info" href="#"
												data-toggle="modal"
												data-target="#addOneClaStu${stuOne.stu_id }" title="添加教师">
													<i class=" icon-ok "></i>
											</a>
												<div class="modal fade" tabindex="-1" role="dialog"
													id="addOneClaStu${stuOne.stu_id }" style="display: none">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<button class="close" type="button" data-dismiss="modal"
															...
															<div class="modal-footer">
																...
																<button type="button" class="btn btn-primary"
																	id="add_claStu_but1"
																	onClick="add_claStu(${stuOne.stu_id },${claId })">确认</button>
															</div>
														</div>
													</div>
												</div></td>
	...
	<!-- end: JavaScript-->
	<script>
	function delete_claStu(stuId,claId)
	{
 		$.ajax({
			type:"post",
			url:"${pageContext.request.contextPath}/classroom/student",
			data:{_method:"DELETE",claId:claId,stuId:stuId},
	...
	function add_claStu(stuId,claId)
	{
		$.ajax({
			type:"post",
			url:"${pageContext.request.contextPath}/classroom/student",
			data:{"claId":claId,"stuId":stuId},
			success:function(data){
				if(data=="OK")
				window.location.reload();
			}
